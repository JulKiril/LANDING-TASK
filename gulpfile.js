...
function watch() {
    ...
    gulp.watch(paths.jsPlugins.src, scripts);
...
// gulp.task('build', gulp.series(clean, gulp.parallel(styles, scripts, html, images)));
 ...
 gulp.task('default', gulp.parallel(watch,browserSync,gulp.series(clean, gulp.parallel(styles, scripts,jsPlugins, html,fonts, images))));
